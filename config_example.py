...
# --- Region of Interest ---
region_geojson = "input/Nairobi.json"  # Boundary polygon (geojson)
population_raster = "input/merged_cropped_raster.tif" # Population raster (.tif in WGS84 coordinate system)
workplaces_csv = "input/Nairobi_workplaces.csv"  # Workplace locations (CSV file)
pois_csv = "input/Nairobi_pois.csv"  # Points of interest (CSV file)
